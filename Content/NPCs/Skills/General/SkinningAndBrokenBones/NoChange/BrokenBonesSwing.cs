...
{
    public class BrokenBonesSwing(NPC npc, BasicSwingSkill.PreSwing preSwing, BasicSwingSkill.OnSwing onSwing, BasicSwingSkill.PostSwing postSwing, BasicSwingSkill.Setting setting) : BasicSwingSkill(npc, preSwing, onSwing, postSwing, setting)
    {
        ...
        public override Vector2 Size => new(74,68);
        ...
        public override void OnSkillDeactivate(NPCSkills changeToSkill)
        {
            ...
            StarOwner.InStrongAxeMode = Main.rand.NextBool(5);
        }
    }
}
