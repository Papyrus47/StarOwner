...
{
    public class DemonicSword_MidgarosSwing : BasicSwingSkill
    {
        public DemonicSword_MidgarosSwing(NPC npc, PreSwing preSwing, OnSwing onSwing, PostSwing postSwing, Setting setting) : base(npc, preSwing, onSwing, postSwing, setting)
        {
        }

        public override Asset<Texture2D> DrawTex => ModAsset.DemonicSword_Midgaros_Async;

        public override int WeaponDamage => 120;

        public override Vector2 Size => new(130,80);
        ...
        public override void OnSkillDeactivate(NPCSkills changeToSkill)
        {
            ...
            if (NPC.ai[3] != 1)
            {
                ...
                NPC.HealEffect(-NPC.lifeMax / 1000);
                NPC.checkDead();
            }
        }
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            gd.Textures[1] = ModAsset.ColorMap_5.Value;
            gd.Textures[2] = ModAsset.Stars1.Value;
