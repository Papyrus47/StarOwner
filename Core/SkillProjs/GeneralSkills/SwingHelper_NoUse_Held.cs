...
{
    public class SwingHelper_NoUse_Held : ProjSkill_Instantiation
    {
        public Player Player;
        public SwingHelper SwingHelper;
        public float Length = 30;
        public Func<bool> CanChange;
        public SwingHelper_NoUse_Held(Player player, SwingHelper swingHelper, ModProjectile proj) : base(proj)
        {
            Player = player;
